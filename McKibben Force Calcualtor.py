...
# Conversion factors
pound_per_newton = 0.224809
kg_per_newton = 0.1019716213

# Convert and print the force in pounds and kilograms
force_pounds = force * pound_per_newton
force_kg = force * kg_per_newton
print("The force generated by the McKibben muscle is:", force_pounds, "pounds")
print("The force generated by the McKibben muscle is:", force_kg, "kilograms")
